...
class DQNAgent:
    ...
    def train(self, state, action, next_state, reward, terminal):
        ...
        td_targets =  batch_rewards + self.discount_factor * np.argmax(self.Q_target.predict(self.sess, batch_next_states))
    ...
    def act(self, state, deterministic):
        ...
        if deterministic or r > self.epsilon:
            ...
            act_values = self.Q_target.predict(self.sess, state)
